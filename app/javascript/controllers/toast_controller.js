...
export default class extends Controller {
  ...
  createToastElement(toast) {
    ...
    closeBtn.innerHTML = `<span class="material-symbols-outlined !text-[14px]">close</span>`;
  ...
  getToastHTML(toast) {
    ...
    const icons = {
      success: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1">check_circle</span>`,
      error: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1">cancel</span>`,
      info: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1">info</span>`,
      warning: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1">warning</span>`,
      danger: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1">dangerous</span>`,
      loading: `<span class="material-symbols-outlined !text-[18px] mr-1.5 -ml-1 animate-spin">progress_activity</span>`,
    };
